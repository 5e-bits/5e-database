...
import Levels from '../en/5e-SRD-Levels.json' with { type: 'json' };
...
import Subclasses from '../en/5e-SRD-Subclasses.json' with { type: 'json' };
import Subspecies from '../en/5e-SRD-Subspecies.json' with { type: 'json' };
import Traits from '../en/5e-SRD-Traits.json' with { type: 'json' };
import WeaponMasteryProperties from '../en/5e-SRD-Weapon-Mastery-Properties.json' with { type: 'json' };
import WeaponProperties from '../en/5e-SRD-Weapon-Properties.json' with { type: 'json' };
...
import { SpellsSchema } from '../schemas/5e-SRD-Spells';
...
describe('2024 schemas', () => {
  ...
  it('spells', () => testAll(Spells, SpellsSchema));
